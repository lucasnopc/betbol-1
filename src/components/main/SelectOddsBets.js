...
export default function SelectOddsBets(props) {
    return <div className="inline-block md:float-right">
            <select className="font-semibold overflow-auto bg-gray-50 uppercase hover:bg-gray-100 float-right border border-gray-100 p-1 mr-2 outline-none cursor-pointer w-full text-gray-700" onChange={(change) => {
