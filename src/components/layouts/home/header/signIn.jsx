...
export default function SignInButton () {
  ...
  {!session && <>
          <div>
              ...
              <span className="cursor-pointer bg-primary hover:bg-primary-ligth p-1 uppercase font-semibold text-white text-sm block-inline mx-1" onClick={() => setEnterSis(!enterSis)}>Entrar / Cadastrar</span>
          </div>
      </>}
  </>
}